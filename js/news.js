...
var texts =
    [
        ...
        "SUSpicious sand",
        "自己喜欢的就是最好的",
        "如果遇到bug或文本错误可以去github提issue，这才是正确的反映bug的方式，而不是[数据丢失]",
        "如果说无尽之锭就是这个游戏的最终版本终点，那么做到这里的时候得保证经验增长率到ω+1，否则需要延长或者等新大数库。",
        "有生之年系列：挖矿增量页集齐元素周期表",
        "植物魔法是科技mod",
        "请将下列事件按发生顺序排序 1、暮色森林更新终焉城堡最终BOSS；2、深渊国度更新高版本；3、GTA6发售；4、RE-LOGIC更新Terraria1.4.5；5、IMR更新v0.8正式版；6、五小时后", //Terraria1.4.5已更新
